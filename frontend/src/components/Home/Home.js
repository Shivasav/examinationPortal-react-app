              ...
              <div class="container">
                <div class="hero-inner">
                  <div class="hero-copy">
                    ...
                    <p class="hero-paragraph is-revealing" style={{color: "white"}}>
                      A platform for handling online examinations for the university.
                    </p>
                    <div class="hero-form field field-grouped is-revealing"></div>
                  </div>
                    ...
                    <div class="feature">
                      <div class="feature-inner">
                        <div class="feature-header mb-16">
                          ...
                          <h4 class="feature-title m-0">Set up Examination</h4>
                        </div>
                        <p class="text-sm mb-0" style={{color: "white"}}>
                          Admins can set up examinations based on the subjects which is completely configurable and driven by spreadsheets
                        </p>
                      </div>
                    </div>
                    <div class="feature">
                      <div class="feature-inner">
                        <div class="feature-header mb-16">
                          ...
                          <h4 class="feature-title m-0">Take Examination</h4>
                        </div>
                        <p class="text-sm mb-0" style={{color: "white"}}>
                          Students can take up examinations scheduled for them.
                        </p>
                      </div>
                    </div>
                    <div class="feature">
                      <div class="feature-inner">
                        <div class="feature-header mb-16">
                          ...
                          <h4 class="feature-title m-0">View Results</h4>
                        </div>
                        <p class="text-sm mb-0" style={{color: "white"}}>
                          Results are automatically generated and can be viewed on the UI as well as exported to spreadsheets or printed for further use
                        </p>
                      </div>
                    </div>
                  </div>
